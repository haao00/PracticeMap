...
void myCameraRotateX(GLdouble angle)
{
  ...
  __camera.Eye[0] = __camera.Centre[0] + (norm[0] * norm[0] * (1 - cos(angle)) + cos(angle)) * dummy[0] + (norm[0] * norm[1] * (1 - cos(angle)) - norm[2] * sin(angle)) * dummy[1] + (norm[0] * norm[2] * (1 - cos(angle)) + norm[1] * sin(angle)) * dummy[2];
  __camera.Eye[1] = __camera.Centre[1] + (norm[1] * norm[0] * (1 - cos(angle)) + norm[2] * sin(angle)) * dummy[0] + (norm[1] * norm[1] * (1 - cos(angle)) + cos(angle)) * dummy[1] + (norm[1] * norm[2] * (1 - cos(angle)) - norm[0] * sin(angle)) * dummy[2];
  __camera.Eye[2] = __camera.Centre[2] + (norm[2] * norm[0] * (1 - cos(angle)) - norm[1] * sin(angle)) * dummy[0] + (norm[2] * norm[1] * (1 - cos(angle)) + norm[0] * sin(angle)) * dummy[1] + (norm[2] * norm[2] * (1 - cos(angle)) + cos(angle)) * dummy[2];

  dummy[0] = __camera.Up[0];
  dummy[1] = __camera.Up[1];
  dummy[2] = __camera.Up[2];

  __camera.Up[0] = (norm[0] * norm[0] * (1 - cos(angle)) + cos(angle)) * dummy[0] + (norm[0] * norm[1] * (1 - cos(angle)) - norm[2] * sin(angle)) * dummy[1] + (norm[0] * norm[2] * (1 - cos(angle)) + norm[1] * sin(angle)) * dummy[2];
  __camera.Up[1] = (norm[1] * norm[0] * (1 - cos(angle)) + norm[2] * sin(angle)) * dummy[0] + (norm[1] * norm[1] * (1 - cos(angle)) + cos(angle)) * dummy[1] + (norm[1] * norm[2] * (1 - cos(angle)) - norm[0] * sin(angle)) * dummy[2];
  __camera.Up[2] = (norm[2] * norm[0] * (1 - cos(angle)) - norm[1] * sin(angle)) * dummy[0] + (norm[2] * norm[1] * (1 - cos(angle)) + norm[0] * sin(angle)) * dummy[1] + (norm[2] * norm[2] * (1 - cos(angle)) + cos(angle)) * dummy[2];
  ...
  if (lightControl)
  {
    for (i = 0; i < 2; i++)
    {
      ...
      light[0] = __camera.Centre[0] + (norm[0] * norm[0] * (1 - cos(angle)) + cos(angle)) * dummy[0] + (norm[0] * norm[1] * (1 - cos(angle)) - norm[2] * sin(angle)) * dummy[1] + (norm[0] * norm[2] * (1 - cos(angle)) + norm[1] * sin(angle)) * dummy[2];
      light[1] = __camera.Centre[1] + (norm[1] * norm[0] * (1 - cos(angle)) + norm[2] * sin(angle)) * dummy[0] + (norm[1] * norm[1] * (1 - cos(angle)) + cos(angle)) * dummy[1] + (norm[1] * norm[2] * (1 - cos(angle)) - norm[0] * sin(angle)) * dummy[2];
      light[2] = __camera.Centre[2] + (norm[2] * norm[0] * (1 - cos(angle)) - norm[1] * sin(angle)) * dummy[0] + (norm[2] * norm[1] * (1 - cos(angle)) + norm[0] * sin(angle)) * dummy[1] + (norm[2] * norm[2] * (1 - cos(angle)) + cos(angle)) * dummy[2];
    }
  }
  glFlush();
}
...
void myCameraTranslateX(GLdouble pan)
{
  ...
  */
  ...
  // 垂直なベクトル(外積の計算)
  norm[0] = dummy[2] * __camera.Up[1] - dummy[1] * __camera.Up[2];
  norm[1] = -(dummy[2] * __camera.Up[0] - dummy[0] * __camera.Up[2]);
  norm[2] = dummy[1] * __camera.Up[0] - dummy[0] * __camera.Up[1];
  ...
  // 垂直なベクトル方向に移動
  __camera.Centre[0] = __camera.Centre[0] + pan * norm[0];
  __camera.Centre[1] = __camera.Centre[1] + pan * norm[1];
  __camera.Centre[2] = __camera.Centre[2] + pan * norm[2];

  __camera.Eye[0] = __camera.Eye[0] + pan * norm[0];
  __camera.Eye[1] = __camera.Eye[1] + pan * norm[1];
  __camera.Eye[2] = __camera.Eye[2] + pan * norm[2];
...
void myCameraTranslateY(GLdouble pan)
{
  ...
  */
  // Upベクトルにそって、視点とカメラ位置を移動
  upCalc();

  __camera.Centre[0] = __camera.Centre[0] + pan * __camera.Up[0];
  __camera.Centre[1] = __camera.Centre[1] + pan * __camera.Up[1];
  __camera.Centre[2] = __camera.Centre[2] + pan * __camera.Up[2];

  __camera.Eye[0] = __camera.Eye[0] + pan * __camera.Up[0];
  __camera.Eye[1] = __camera.Eye[1] + pan * __camera.Up[1];
  __camera.Eye[2] = __camera.Eye[2] + pan * __camera.Up[2];

  glFlush();
}

// 　カメラをZ軸の方向に動かす。
void myCameraTranslateZ(GLdouble pan)
{
  /*
    eyex    cos  0   sin  \  / EyeX \
    eyey =   0   1    0    | | EyeY |
  ...
  */
  ...
  __camera.Eye[0] = __camera.Eye[0] + pan * dummy[0];
  __camera.Eye[1] = __camera.Eye[1] + pan * dummy[1];
  __camera.Eye[2] = __camera.Eye[2] + pan * dummy[2];
